...
class StreamingCore : Service(), AudioManager.OnAudioFocusChangeListener {
    ...
    private val broadcastChangedMetaData = Intent(broadcastChangedMetaDataName)
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        player?.addMetadataOutput {
            ...
            localBroadcastManager.sendBroadcast(broadcastChangedMetaData.putExtra("changedMetaData", metaData))
        }
