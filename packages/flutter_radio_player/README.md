...
See the [example app](https://github.com/Sithira/FlutterRadioPlayer/tree/master/example) for a complete implementation.
...
[MIT](https://github.com/Sithira/FlutterRadioPlayer/blob/master/LICENSE)
